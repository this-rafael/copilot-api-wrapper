...
export interface GitLogResultMessage {
  type: 'git.log.results';
  cwd: string;
  commits: GitCommitInfo[];
}

export interface GitStageResultMessage {
  type: 'git.stage.results';
  cwd: string;
  paths: string[];
}

export interface GitUnstageResultMessage {
  type: 'git.unstage.results';
  cwd: string;
  paths: string[];
}

export interface GitCommitResultMessage {
  type: 'git.commit.results';
  cwd: string;
  hash: string;
  message: string;
}
...
export interface GitPushResultMessage {
  type: 'git.push.results';
  cwd: string;
  remote?: string;
  branch?: string;
}

export interface GitPullResultMessage {
...
export interface GitBranchesResultMessage {
  type: 'git.branches.results';
  cwd: string;
  current: string;
  branches: GitBranchInfo[];
}

export interface GitCheckoutResultMessage {
  type: 'git.checkout.results';
  cwd: string;
  branch: string;
}
